...
python3 scripts\gfxrecon.py install-apk tools\quest_replay\build\outputs\apk\debug\quest_replay-debug.apk
REM python3 scripts\gfxrecon.py install-apk tools\quest_replay\build\outputs\apk\release\quest_replay-release.apk
...
adb install -r build\outputs\apk\Vulkan\debug\sample_08_finger_painting3-Vulkan-debug.apk
REM adb install -r build\outputs\apk\Vulkan\release\sample_08_finger_painting3-Vulkan-release.apk
